...
BOT_TOKEN = "7171224698:AAFtcEjrDJp97bTsiMzvHn_bwgFIFKnACFk"
PAYMENT_CHANNEL = "@Lucifer_payment" #add payment channel here including the '@' sign
OWNER_ID = 6465256721 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@hackzarea","@saidhanusj"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
